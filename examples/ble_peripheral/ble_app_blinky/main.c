...
#define LEDBUTTON_Toggle                BSP_BOARD_LED_3

#define LEDBUTTON_BUTTON_1              BSP_BUTTON_1

//#define DEVICE_NAME                     "Nordic_Blinky"                         /**< Name of device. Will be included in the advertising data. */
#define DEVICE_NAME                     "HHY_Blinky" 
...
static void led_write_handler(uint16_t conn_handle, ble_lbs_t * p_lbs, uint8_t led_state)
{
    if (led_state)
    {
        ...
        bsp_board_led_invert(LEDBUTTON_Toggle);    
...
static void button_event_handler(uint8_t pin_no, uint8_t button_action)
{
    ...
    switch (pin_no)
    {
        ...
        case LEDBUTTON_BUTTON_1:
            NRF_LOG_INFO("Send button_1 state change.");
            err_code = ble_lbs_on_button_change(m_conn_handle, &m_lbs, 5);
